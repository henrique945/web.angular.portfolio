...
export const iquot: ProjectInterface = {
  ...
  description: 'Developed in <b>NestJs (NodeJs + PostgresQL)</b> with <b>AWS Cloud (Aws Lambda + S3)</b> and integrated with <b>Aws SNS for SMS messages</b> and <b>Google Maps API (Geocoding)</b>.\n' +
    ...
    'You will receive quotations from stores and manufacturers of building materials for you to compare the best prices and save on your work.\n' +
    'We use <b>Google to calculate the users\' coordinates and the distance between the seller and the final buyer</b>.\n' +
    ...
    'We also use another <b>routine to notify users</b> when a new quote is added.\n' +
    'When the budget is accepted, everyone involved receives an <b>SMS notification on their mobile (Aws SNS)</b>.\n',
